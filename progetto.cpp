	        	...
	        	case 1:
    {
        ...
        break;
...

            {
                ...
                for (int a = 0; a < contatore; a++)
			{
				cout <<cars[a].nome<<"  numero macchin: "<<a
					 << endl;
			if (cars[a].presa == true)
			{
				prenotata = "Prenotata";
				...
				cout << "Prenotazione numero: "<<pren<<"\nCliente che ha prenotato la macchina: " << cars[a].cliente_nome << " " << cars[a].cliente_cognome << endl
            ...
            if(cars[b].n_pren>0)
            {
                ...
                cout<<"Selezioni il numero della sua prenotazione"<<endl;
